...
II. Опис черепка:
    1. Структура черепка (неоднорідна, однородна);грубозерниста, погано  вимучена, з включенням кварцу, 
        шамоту, дрісви і т.д.; дрібнозерниста, добре вимучена;
    2. Визначити черепок (дзвінкий, глухий, щільний, пористий).;
    3. Домішки: органічні (солома, полова, мушль і т.д.); неорганічні 
        (кварц, пісок, шамот, кровавик і т.д.);\n    4. Вказати колір черепка, міцність.'''
        self.ceramics_damage_description = '''\n(КЕРАМІКА):
    1. Визначити випал (рівномірний, нерівномірний, деформований під дією високої температури, 
        повторний випал, деформації, поверхня спучена, слоїста і т.д.)'''
...
class Metal:
    ...
    1. Визначити ступінь збереженості предмета:
        ...
        -Предмет задовільної збереженості (новий метал, загальне забруднення, суцільна корозія або благородна патина, 
            декор добре читається, металеве ядро не мінералізоване,наявні потертості, незначна деформація)
        -Новий метал поганої збереженості (загальні пило-брудові нашарування, суцільна корозія, 
            наявні локальні рецедивуючі продукти корозії, значна деформація, втрати).
        -Археологічний метал (наявний товстий шар корозійного нашарування, міжкристалітна корозія, крихкість, тріщини, 
            втрати, крізна корозія. Декор читається погано, форми предмета та металеве ядро збережені)
        -Археологічний метал з частково мінералізованим металевим ядром (форма предмету читається погано, 
            механічна міцність слабка, можливі руйнування, крізна корозія, наявна часткова мінералізація металевого ядра).
        -Археологічний метал з повністю мінералізованим металевим ядром (предмет перетворився на безформну масу, 
            що складається з продуктів корозії і не має механічної міцності).'''
