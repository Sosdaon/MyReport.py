...
III. Забруднення:
    ...
    2.Стійкі (вапнякові, природні та синтетичні смоли, висоли, гіпсові забруднення, плями кислів металів, сліди кіптяви, 
        пеку, жиру, плями від пластиліну, масляної фарби, воску, клейові забруднення, чорнила, туш, записи фарбами (якого кольору), 
        забруднення фарбами від попередніх тонувань – місцезнаходження фарби, забруднення на зламах фрагментів 
        (від клею, вапнякових нашарувань, пило брудові, ґрунтові і т.д.).
    3.Визначити за візуальним спостереженням яким клеєм склеєно фрагменти (клеєм БФ (світло-коричневого, коричневого, 
        червоного кольору, прозорий), ПВА (полівінилацетатний клей молочного кольору, непрозорий, безбарвний, прозорий)
...
V. Опис наявних втрат та пошкоджень:
    ...
    5. Визначити дефекти:
        ...
        -визначити дефекти тонувань (якщо є розпис, консерваційного покриття – описати колір, стан збереження, наявні значні або 
            незначні, часткові, локальні втрати, потертості відшарування (вказати форму, розмір, розташування);
